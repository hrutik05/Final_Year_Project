                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {[
                        ...
                        { name: 'Corporate Law', icon: '🏢', desc: 'Companies Act, SEBI' },
                        { name: 'Family Law', icon: '❤️', desc: 'Marriage, Divorce, Adoption' },
                        { name: 'Property Law', icon: '🏠', desc: 'Real estate, Registration' },
                        { name: 'Labour Law', icon: '💼', desc: 'Employment, Industrial' },
                        { name: 'Consumer Law', icon: '👥', desc: 'Consumer protection' }
                      ].map((area, index) => (
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <div className="space-y-6">
                        {[
                          { date: 'March 2025', title: 'Voice Interface Beta', status: 'upcoming' },
                          { date: 'June 2025', title: 'Document Analysis Feature', status: 'upcoming' },
                          { date: 'September 2025', title: 'Mobile App Launch', status: 'upcoming' },
                          { date: 'December 2025', title: 'API Platform Release', status: 'planned' },
